...
| **Build + release** — root `build.ps1`; single **manual-trigger** `.github/workflows/release.yml` (`workflow_dispatch`: version bump → e2e gate → bundle → optional tag → GitHub Release zip + manifest). No auto CI on push/PR (D3dx-style). | ✅ 2026-07-13 (release model revised 2026-07-14) |
