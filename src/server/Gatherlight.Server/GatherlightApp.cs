...
public static class GatherlightApp
{
        ...
        GatherlightServerOptions? options = null, string[]? args = null, ServerConfigService? config = null)
    {
        ...
        builder.Services
            ...
            // Transition wrappers over the Node puppeteer verifiers (port per ROADMAP phase 7)
            .AddSingleton<IGatherlightTool, PolicyCheckTool>()
            .AddSingleton<IGatherlightTool, HotelInfoTool>()
            .AddSingleton<IGatherlightTool, RestaurantInfoTool>()
            .AddSingleton<IGatherlightTool, FlightScheduleTool>()
            ...
            // Document / media processing (PdfPig + PDFsharp + ImageSharp)
