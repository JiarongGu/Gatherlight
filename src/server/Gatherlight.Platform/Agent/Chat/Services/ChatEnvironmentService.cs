...
public sealed class ChatEnvironmentService
{
    ...
    private const string UiSpecMd = """
        <!-- UI_CONTRACT_VERSION: 2 — generated by Gatherlight. App-managed: edits are replaced. -->
        # 界面块 · UI blocks
        ...
        | `Table` | no | `columns` (required, strings), `rows` (required, array of string arrays), `caption` |
