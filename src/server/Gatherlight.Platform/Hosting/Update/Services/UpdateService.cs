...
using Gatherlight.Server.Platform.Hosting.Update.Models;

namespace Gatherlight.Server.Platform.Hosting.Update.Services;
...
public sealed class UpdateService : IUpdateService
{
    ...
    private static string CurrentVersion() => AppVersion.Semver;
